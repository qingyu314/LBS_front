  ...
  >
    <div class="drawer-post-container">
      <el-image :src="info.imgUrl" class="drawer-image"/>
        <el-button plain type="danger" v-if="!inEdit[0]" @click="confirmDeleteWhole"
      ...
      <div class="drawer-post-content">
        ...
        <el-button text v-if="!inEdit[0]" @click="editComment(cmtFirst.comment, -1)"
                   :icon="Edit" size="large"/>
      </div>
      <div class="cmt-button-group" v-if="inEdit[0]">
    ...
    <div v-for="(item,index) in cmtList" :key="item.cmtId" class="cmt-container">
      ...
      <div class="cmt-button-group" v-if="inEdit[index+1]">
